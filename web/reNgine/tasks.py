...
def subdomain_discovery(
	...
	default_subdomain_tools.append('puredns')
	...
	for tool in tools:
		...
		if tool in default_subdomain_tools:
			if tool == 'amass-passive':
				...
				print("Running Puredns0")
				cmd = f'puredns bruteforce /usr/src/wordlist/combined_subdomains.txt {host} -r /usr/src/wordlist/dns-resolvers.txt --write {self.results_dir}/subdomains_purednss.txt'
